        ...
        >
            ...
            {onClose && (
                <button
                    ...
                    className="cursor-pointer absolute top-2 right-0 z-10 bg-black/60 hover:bg-black/80 text-white rounded-full p-1 transition-colors shadow-md"
                >
                    <svg
            ...
            <div className="flex gap-3 p-3">
                ...
                <div className="flex-1 flex flex-col justify-between min-w-0">
                    {/* Title */}
                    <h3 onClick={handleCardClick} className="cursor-pointer hover:text-[#008DDA] font-semibold text-sm text-gray-900 line-clamp-2 break-words leading-snug mb-1 transition-colors duration-150">
                        {title}
                    </h3>
                    ...
                    <div className="flex items-center gap-3">
                        <div className="flex-1">
                            <p className="text-xs font-bold text-[#008DDA]">
                                {formatPrice(price)}
                            </p>
                        </div>
